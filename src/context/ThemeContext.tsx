...
const DARK: ThemeTokens = {
  ...
  windowShadowFocused: "0 28px 72px rgba(0,0,0,0.85), 0 0 16px rgba(74,222,128,0.06)",

  transition: "background-color 280ms ease-in-out, color 280ms ease-in-out, border-color 280ms ease-in-out, box-shadow 280ms ease-in-out",
}
...
const LIGHT: ThemeTokens = {
  ...
  windowShadowFocused: "0 20px 56px rgba(0,0,0,0.18), 0 0 12px rgba(37,99,235,0.08)",
